                    ...
                    <div class="card bg-base-100 w-full shadow-xl p-4 mt-1 text-left">
                        <div class="card-body">
                            ...
                            <div class="grid grid-cols-1 gap-1">
                                <p><span class="font-bold">Position:</span> {{  typedAdvisorProfile?.academic_position?.academic_position_name || "ไม่พบข้อมูล" }} </p>
                                ...
                                <p><span class="font-bold">Department:</span> {{ typedAdvisorProfile?.department ? `${typedAdvisorProfile.department.department_name} (${typedAdvisorProfile.department.initials})` : "ไม่พบข้อมูล" }} </p>
